...
const teamMembers = [
  {
    name: "Mr. Udara Illukkumbura",
    role: "Director",
    company: "Zeus Power International (Pvt) Ltd",
    image: "/images/1.webp",
  },
  {
    name: "Mr. Lahiru Perera",
    role: "Director",
    company: "Zeus Power International (Pvt) Ltd",
    image: "/images/2.webp",
  },
  ...
  {
    name: "Mrs. Uresha Dissanayaka",
    role: "Engineer Electrical Projects & Services",
    company: "Zeus Power International (Pvt) Ltd",
    image: "/images/4.webp",
  }
];
      ...
      <div className="container-modern relative z-10">
        ...
        >
          ...
          <p className="text-body-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
            Meet the experienced leaders who guide Zeus Power International&apos;s mission
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {teamMembers.map((member, index) => (
            ...
            >
              <div className="modern-card p-6 text-center group-hover:scale-[1.02] transition-all duration-300 h-full flex flex-col">
                ...
                <div className="flex flex-col flex-1 justify-center">
                  ...
                  <p className="text-body font-medium text-gray-700 dark:text-gray-200 mb-1">
                    {member.role}
                  </p>
